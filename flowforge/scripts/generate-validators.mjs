...
const diagramTypes = ['bpmn', 'workflow', 'sequence', 'dataflow', 'lifecycle', 'architecture', 'journey', 'infoflow', 'stakeholder-map', 'capability', 'okr-tree', 'north-star', 'growth-loop', 'launch-plan', 'feedback-pipeline'];
...
for (const type of diagramTypes) {
  ...
  schemaIds[type.replaceAll('-', '_')] = schema.$id;
}
