...
FlowForge ships a bounded catalogue of 107 commonly used brands for architecture,
...
`node bin/flowforge.mjs brands capture <url> --json`, then author the returned
...
and intended referential use before adding or updating a mark. FlowForge does not
