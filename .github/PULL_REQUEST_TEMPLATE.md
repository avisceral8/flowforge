...
List regenerated files such as Gallery pages, guides, README proofs, or `flowforge.zip`. If none changed, explain why they remain fresh.

## Checklist

- [ ] I used a minimal focused change and preserved existing typed JSON behavior unless the issue requires a contract change.
- [ ] I ran the relevant targeted tests and `npm test` in `flowforge/`.
