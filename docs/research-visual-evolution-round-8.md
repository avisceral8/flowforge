...
FlowForge can focus a node after the reader sees it, and guided views can lead a reader through authored paths. A reader opening an unfamiliar or wide diagram still has no direct answer to “where is Redis?”, “which node owns audit?”, or “show me the worker.”
