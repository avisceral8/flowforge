...
FlowForge artifacts now support focus, relationship inspection, search, route
...
- [Neo4j Bloom's default actions and shortcuts](https://neo4j.com/docs/bloom-user-guide/current/bloom-appendix/bloom-appendix/)
  ...
  explicit action names alongside shortcuts. FlowForge should likewise describe
...
- [React Flow Controls](https://reactflow.dev/api-reference/components/controls)
  ...
  custom control buttons. FlowForge's existing diagram navigation should remain
...
- [yFiles' shortcut reference](https://docs.yworks.com/yfiles-html/dguide/interaction-shortcuts/)
  ...
  interaction system. FlowForge's guide therefore needs real buttons and working
