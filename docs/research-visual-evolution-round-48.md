...
The remaining motion gap is similar: FlowForge's exact-edge Directional Flow Pulse
...
### Current FlowForge contract

`flowforge/assets/template.html` already owns one strong exact-edge surface:
