...
What should FlowForge add after Node Finder, Semantic Camera, Relationship Lens,
...
This is a useful boundary for FlowForge: the overview should preserve spatial
...
3. Node colors derived from FlowForge's authored semantic kinds.
