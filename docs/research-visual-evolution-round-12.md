...
FlowForge does not add wheel zoom, inertial physics, a minimap, editable node positions, or a persistent camera model in JSON. The camera interprets semantic selections inside a compiled artifact; it never becomes part of the diagram source of truth.
