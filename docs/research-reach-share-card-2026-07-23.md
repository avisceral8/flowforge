...
FlowForge should combine the interaction and sharing patterns without copying their causal claims. Its graph is the relationship set authored into one diagram, not a complete code index.
