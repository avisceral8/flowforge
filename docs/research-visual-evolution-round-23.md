...
Round 22 made FlowForge's rich viewer actions discoverable. The next problem is
...
- [yFiles' large-graph performance guide](https://docs.yworks.com/yfiles-html/dguide/advanced/large_graph_performance.html)
  ...
  transferable value for FlowForge is readability, not yFiles' renderer or
  performance stack.
...
- [Sigma.js' settings](https://v4.sigmajs.org/reference/settings/)
  exposes a rendered-size threshold plus density-based label culling. FlowForge's
...
- [G6's FixElementSize behavior](https://g6.antv.antgroup.com/en/manual/behavior/fix-element-size)
  ...
  zooming. FlowForge should likewise make the zoom control describe a reading
