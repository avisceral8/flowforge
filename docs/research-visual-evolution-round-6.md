...
FlowForge should not chase a large style count. It should offer a small set of audience-specific identities that preserve the same semantic IDs, SVG geometry, guided views, export path, and validators.
