...
The built-in browser's multi-iframe Gallery host emitted source-less observer messages from its inspection environment; isolated standalone and direct-embed artifact pages were clean, so these were not attributed to FlowForge source.
...
- `flowforge.zip`: `0d129612c2dfd4145f03a5f9b67730a1001dfe043c23e3287cd050663227e3cc`
