...
FlowForge remains a technical-diagram compiler that produces a self-contained artifact. It does not add draggable editing, a global graph store, plugin installation, layout mutation, or relationship drill-down DSL in this slice. A future multi-view drill-down should be justified by real diagrams that cannot be understood through named one-hop traversal and bounded guided views.
