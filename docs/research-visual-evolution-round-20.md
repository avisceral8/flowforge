...
FlowForge already supports authored Story Trails, one-hop Intent Trace, durable
...
- [Cytoscape.js graph algorithms](https://js.cytoscape.org/#collection/algorithms)
  ...
  let the caller explicitly choose directed traversal. FlowForge should likewise
...
- [Graphology's shortest-path package](https://graphology.github.io/standard-library/shortest-path.html)
  ...
  FlowForge has no authored costs, so “fewest real relationship hops” is a more
...
- [yFiles shortest-path documentation](https://docs.yworks.com/yfiles-html/api/ShortestPath/)
  ...
  matches FlowForge's existing separation between Intent Trace, Focus, Story,
