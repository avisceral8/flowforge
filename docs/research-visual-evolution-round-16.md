...
FlowForge does not add D2-style inherited boards, a parallel-step DSL, a second dynamic-view schema, animated canonical SVG exports, or an endless loop. Story Beats are a bounded reading aid over one stable technical diagram, not a presentation authoring platform.
