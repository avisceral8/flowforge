...
FlowForge already has the deeper reading product: exact semantic identity, search,
...
- **Adapt:** keep FlowForge's exact existing SVG geometry and semantic palette;
...
- **Adapt:** exercise Route and Reach cards, Story, trace motion, dark/light,
  and canonical SVG through FlowForge's existing gates.
...
FlowForge's own landing-page paper identity and remains recognizable in both dark
and light themes.
